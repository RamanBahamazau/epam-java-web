...
public class TetrahedronSurfaceAreaComparatorTest {

    private final Comparator<Tetrahedron> comparator = new TetrahedronSurfaceAreaComparator();
    ...
    @Test
    public void shouldReturnMinusOne_whenCompare_givenFirstShapeWithSurfaceAreaLessThenSecond() {
        // given
    ...
    @Test
    public void shouldReturnMinusOne_whenCompare_givenShapesWithSameSurfaceArea() {
        // given
        Tetrahedron tetrahedron1 = new Tetrahedron(1L, tetrahedronDotList1);
    ...
    @Test
    public void shouldReturnOne_whenCompare_givenFirstShapeWithSurfaceAreaGreaterThenSecond() {
        // given
